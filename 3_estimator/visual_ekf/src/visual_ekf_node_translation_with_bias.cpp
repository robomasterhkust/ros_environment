...
MatrixXd R = MatrixXd::Identity(6, 6); // prediction noise covariance
...
queue<Matrix<double, 9, 1>> x_history;
...
//    n.param("imu_raw", imu_topic, string("/dji_sdk/imu")); // 400Hz
    ...
    R.topLeftCorner(3, 3)     = acc_weight * MatrixXd::Identity(3, 3); // accelerometer noise
    R.bottomRightCorner(3, 3) = acc_bias_weight * MatrixXd::Identity(3, 3); // accelerometer noise
