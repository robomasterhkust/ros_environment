...
bool
DJISDKNode::missionWpUploadCallback( dji_sdk::MissionWpUpload::Request& request,
                                     dji_sdk::MissionWpUpload::Response& response )
{
    ...
    initAck = vehicle->missionManager->init( DJI_MISSION_TYPE::WAYPOINT, WAIT_TIMEOUT, &wpInitData );

    ROS_DEBUG( "ack.info: set=%i id=%i", initAck.info.cmd_set, initAck.info.cmd_id );
    ...
    for ( auto waypoint : request.waypoint_task.mission_waypoint )
    {
        ...
        std::copy( waypoint.waypoint_action.command_parameter.begin( ),
                   waypoint.waypoint_action.command_parameter.end( ), wpData.commandParameter );

        uploadAck = vehicle->missionManager->wpMission->uploadIndexData( &wpData, WAIT_TIMEOUT );
...
bool
DJISDKNode::missionWpActionCallback( dji_sdk::MissionWpAction::Request& request,
...
bool
DJISDKNode::missionWpGetSpeedCallback( dji_sdk::MissionWpGetSpeed::Request& request,
...
bool
DJISDKNode::missionWpSetSpeedCallback( dji_sdk::MissionWpSetSpeed::Request& request,
                                       dji_sdk::MissionWpSetSpeed::Response& response )
{
    ...
    if ( vehicle->missionManager->wayptCounter > 0 )
    {
        velAck = ( vehicle->missionManager->wpMission->updateIdleVelocity( request.speed, WAIT_TIMEOUT ) );
    }
    else
    {
        ROS_ERROR( "no waypoint mission initiated " );
...
bool
DJISDKNode::missionWpGetInfoCallback( dji_sdk::MissionWpGetInfo::Request& request,
                                      dji_sdk::MissionWpGetInfo::Response& response )
{
    ...
    if ( vehicle->missionManager->wayptCounter > 0 )
    {
        ...
        ROS_ERROR( " Do Not support this function." );
...
bool
DJISDKNode::missionHpUploadCallback( dji_sdk::MissionHpUpload::Request& request,
                                     dji_sdk::MissionHpUpload::Response& response )
{
    ...
    vehicle->missionManager->init( DJI_MISSION_TYPE::HOTPOINT, WAIT_TIMEOUT, ( void* )hpInitData );
...
bool
DJISDKNode::missionHpActionCallback( dji_sdk::MissionHpAction::Request& request,
...
bool
DJISDKNode::missionHpGetInfoCallback( dji_sdk::MissionHpGetInfo::Request& request,
...
bool
DJISDKNode::missionHpUpdateYawRateCallback( dji_sdk::MissionHpUpdateYawRate::Request& request,
                                            dji_sdk::MissionHpUpdateYawRate::Response& response )
{
    ...
    if ( vehicle->missionManager->hotptCounter > 0 )
    {
        ack = vehicle->missionManager->hpMission->updateYawRate( yawRate, WAIT_TIMEOUT );
    }
    else
    {
        ROS_ERROR( "no hotpoint mission initiated " );
...
bool
DJISDKNode::missionHpResetYawCallback( dji_sdk::MissionHpResetYaw::Request& request,
...
bool
DJISDKNode::missionHpUpdateRadiusCallback( dji_sdk::MissionHpUpdateRadius::Request& request,
                                           dji_sdk::MissionHpUpdateRadius::Response& response )
{
    ...
    if ( vehicle->missionManager->hotptCounter > 0 )
    {
        ack = vehicle->missionManager->hpMission->updateRadius( request.radius, WAIT_TIMEOUT );
    }
    else
    {
        ROS_ERROR( "no hotpoint mission initiated " );
