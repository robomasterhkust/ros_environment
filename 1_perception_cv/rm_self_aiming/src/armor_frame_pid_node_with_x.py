...
class armor_frame_pid_with_x_node:
    def __init__(self):
    ...
    def callback(self, pnp):
        ...
        if abs(pnp.twist.linear.x) < sys.float_info.epsilon:
            ...
            vx = x_kp * self.x_err + x_kd * (self.x_err - self.prev_x_err)
...
if __name__ == "__main__":
    rospy.init_node('armor_frame_pid_with_x_node')
    pid = armor_frame_pid_with_x_node()
    rospy.spin()
