...
class ConcurrentQueue
{
  public:
    ...
    */
    ...
    //TODO: use volatile to wait for data? otherwise other processes maybe too fast leaving no input
    bool peek(T *&out)
    {
        ...
        if (result = (toWritePos != toReadPos))
        {
            //the object should do deep copy by itself
            out = new T(*buffer[toReadPos]);
        }
        return result;
    }
