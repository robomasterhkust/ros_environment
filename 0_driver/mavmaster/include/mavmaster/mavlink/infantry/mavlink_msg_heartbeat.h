...
#define MAVLINK_MSG_ID_HEARTBEAT_CRC 138
#define MAVLINK_MSG_ID_0_CRC 138
 ...
 *
 * @param type Type of the MAV (soldier, sentry, etc., up to 5 types, defined in ROBO_TYPE ENUM)
 * @param base_mode System mode bitfield, see ROBO_MODE_FLAGS ENUM in mavlink/include/mavlink_types.h
 * @param custom_mode A bitfield for use for autopilot-specific flags.
 * @param system_status System status flag, see ROBO_STATE ENUM
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_heartbeat_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t type, uint8_t base_mode, uint32_t custom_mode, uint8_t system_status)
{
...
{
    return mavlink_msg_heartbeat_pack(system_id, component_id, msg, heartbeat->type, heartbeat->base_mode, heartbeat->custom_mode, heartbeat->system_status);
}
...
{
    return mavlink_msg_heartbeat_pack_chan(system_id, component_id, chan, msg, heartbeat->type, heartbeat->base_mode, heartbeat->custom_mode, heartbeat->system_status);
}
...
static inline void mavlink_msg_heartbeat_send(mavlink_channel_t chan, uint8_t type, uint8_t base_mode, uint32_t custom_mode, uint8_t system_status)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_HEARTBEAT_LEN];
    _mav_put_uint32_t(buf, 0, custom_mode);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_heartbeat_send(chan, heartbeat->type, heartbeat->base_mode, heartbeat->custom_mode, heartbeat->system_status);
#else
 ...
 */
static inline void mavlink_msg_heartbeat_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t type, uint8_t base_mode, uint32_t custom_mode, uint8_t system_status)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 *
 * @return Type of the MAV (soldier, sentry, etc., up to 5 types, defined in ROBO_TYPE ENUM)
 */
 ...
 *
 * @return System mode bitfield, see ROBO_MODE_FLAGS ENUM in mavlink/include/mavlink_types.h
 */
 ...
 *
 * @return System status flag, see ROBO_STATE ENUM
 */
